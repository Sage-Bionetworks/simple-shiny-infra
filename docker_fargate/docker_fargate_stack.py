...
class DockerFargateStack(Stack):
    ...
    def __init__(self, scope: Construct, context: str, env: dict, vpc: ec2.Vpc, **kwargs) -> None:
        ...
        load_balanced_fargate_service = ecs_patterns.ApplicationLoadBalancedFargateService(
            ...
            # TODO Restore circuit_breaker=ecs.DeploymentCircuitBreaker(rollback=True), # Enable rollback on deployment failure
        ...
        # https://docs.aws.amazon.com/cdk/api/v1/python/aws_cdk.aws_elasticloadbalancingv2/ApplicationTargetGroup.html#aws_cdk.aws_elasticloadbalancingv2.ApplicationTargetGroup.enable_cookie_stickiness
        if env.get("STICKY")=="true":
